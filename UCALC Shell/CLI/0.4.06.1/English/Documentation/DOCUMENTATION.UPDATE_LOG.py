			if WikIDSelect == 10000:
				...
				more1 = input("Read more? [ENTER]")
				print ("UCalc Alpha 4 series:\nUCalc4.00")
				print ("No documentation available")
				more1 = inout("Read more? [ENTER]")
				print ("UCalc Alpha 4 series:\nUCalc 0.4.01")
				print ("No documentation available")
				more1 = inout("Read more? [ENTER]")
				print ("UCalc Alpha 4 series:\nUCalc 0.4.02")
				...
				more1 = inout("Read more? [ENTER]")
				print ("UCalc Alpha 4 series:\nUCalc 0.4.06.0")
				print ("Sorry for not updating the update log in a while, development has been all over the place")
				print ("There are some issues with the Stephen Hawking voicelines, for some reason, the export maxed out at 57 seconds, and ignored most of the quote")
				print ("Until we find a way to do it + when we get interest in it, we will add it back in")
				print ("\nNew features in this build: ")
				print ("\nMeet Reggie!\nReggie is a new registry viewer for UCALC to see the String, Integer, and Float values within the program.")
				print ("It shows you the usage of these variables, and gives you a better understanding of how the variables work, so developers can start easier")
				print ("Right now, it is only a registry viewer. You will have to manually modify files if you want to edit the registry")
				print ("\nNew location system\nThere is a new mode for location selection. It is mainly just a customize feature, an extra feature.")
				print ("The range of the location feature goes beyond Earth, and currently is only for customization purposes")
