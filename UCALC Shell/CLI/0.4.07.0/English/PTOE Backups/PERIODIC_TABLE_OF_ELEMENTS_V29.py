...
while (loopForever == 1):
	print ("============================================================================\\")
	print ("Note: Table ID is the atomic number | Periodic table tool for UCALC V0.29   |")
	print ("============================================================================|")
...
# adding all of the wikipedia documentation makes this take way longer. It will come in useful though - Sean Myrick @ 1:34 pm on December 30th 2018 (build 28)
# finally finished the recovery process. I have all the data back, now to complete the project - Sean Myrick @ 1: pm on December 30th 2018 (build 29)
'''
lost media
'''
...
# V28 - Updated change log 
# V28 - Fixed minor bug that caused program to not start 
# V28 - Added Silver and Cadmium (elements 47 and 48)
# V29 - Updated change log 
# V29 - Added Indium and Tin (elements 49 and 50)
'''
# end of script
'''
# end of program
