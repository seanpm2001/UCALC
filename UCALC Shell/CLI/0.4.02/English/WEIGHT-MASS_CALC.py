print (" ")
print (" ")
print (" _    _  ____  ____  ___  _   _  ____      __    _  _  ____     __  __    __    ___  ___ ")
print ("( \\/\\/ )( ___)(_  _)/ __)( )_( )(_  _)    /__\\  ( \\( )(  _ \\   (  \\/  )  /__\\  / __)/ __)")
print (" )    (  )__)  _)(_( (_-. ) _ (   )(     /(__)\\  )  (  )(_) )   )    (  /(__)\\ \\__ \\\\__ \\")
print ("(__/\\__)(____)(____)\\___/(_) (_) (__)   (__)(__)(_)\\_)(____/   (_/\\/\\_)(__)(__)(___/(___/")
...
print (" ")
enterAnEnter = input("Press [ENTER] key to start! ")		
calcIDSes = int(18)
if calcIDSes == 18:
	if calcIDSes == 18:
		if calcIDSes == 18:
				...
				if calcIDSes == 18:
					...
					if mode18 == 1:
						...
						if measureType == ("Hundredweight"):
							...
							print ("This is also equal to: ")
							AtomicMassUnit = float((curanswer * 273159734000000008192) * 100000000)
							...
							bloat1 = input("| FAIL! SETUP RESTARTING (we can't fix the bug right now, we are porting features in. Stabilizing later, my bad)")
						if measureType == ("Kilogram"):
							curanswer = float(KilogramCalc + unit2)
							print ("The answer is: " + str(curanswer) + " Kilograms")
							print ("This is also equal to: ")
							AtomicMassUnit = float((curanswer * 60221412899999997952) * 10000000)
							carats = float((curanswer * 0.5) * 10000) 
							centigram = float((curanswer * 10) * 10000)
							decigram = float((curanswer * 1) * 10000)
							dekagram = float((curanswer * 0.01) * 10000)
							dram = float((curanswer * 0.05643834) * 10000)
							femtogram = float((curanswer * 100000000000000) * 10000)
							frenchQuintal = float((curanswer * 0.0000006713662) * 10000)
							grain = float((curanswer * 1.543236) * 10000)
							gram = float((curanswer * 0.1) * 10000)
							hectogram = float((curanswer * 0.001) * 10000)
							hundredWeight = float((curanswer * 0.000002204623) * 10000)
							longTon = float((curanswer * 0.00000009842035) * 10000)
							megagram = float((curanswer * 0.0000001) * 10000)
							metricQuintal = float((curanswer * 0.00004535924) * 10000)
							metricTon = float((curanswer * 0.0000001) * 10000)
							microgram = float((curanswer * 100000) * 10000)
							milligram = float((curanswer * 4535.924) * 10000)
							ounce = float((curanswer * 0.003527396) * 10000)
							picogram = float((curanswer * 100000000000) * 10000)
							pound = float((curanswer * 0.0002204623) * 10000)
							shortTon = float((curanswer * 0.0000001102311) * 10000)
							slug = float((curanswer * 0.000006852177) * 10000)
							stick = float((curanswer * 0.0008695652) * 10000)
							stone = float((curanswer * 0.0000157473) * 10000)
							tola = float((curanswer * 0.008573532) * 10000)
							ton = float((curanswer * 0.0000001102311) * 10000)
							TroyOunce = float((curanswer * 0.003215075) * 10000)
							USQuintal = float((curanswer * 0.000002204623) * 10000)
							print ("Atomic Mass Units: " + str(AtomicMassUnit))
							print ("Carats: " + str(carats))
							print ("Centigrams:  " + str(centigram))
							print ("Decgrams: " + str(decigram))
							...
							bloat1 = input("| FAIL! SETUP RESTARTING (we can't fix the bug right now, we are porting features in. Stabilizing later, my bad)")
						if measureType == ("Long ton"):
							curanswer = float(LongTonCalc + unit2)
							print ("The answer is: " + str(curanswer) + " Long Tons")
							print ("This is also equal to: ")
							AtomicMassUnit = float((curanswer * 611879665780000030720) * 100000000)
							carats = float((curanswer * 508.025) * 10000) 
							centigram = float((curanswer * 10160.5) * 10000)
							decigram = float((curanswer * 1016.05) * 10000)
							dekagram = float((curanswer * 10.1605) * 10000)
							dram = float((curanswer * 57.34417) * 10000)
							femtogram = float((curanswer * 101605000000000000) * 10000)
							frenchQuintal = float((curanswer * 0.0006821417) * 10000)
							grain = float((curanswer * 1568.005) * 10000)
							gram = float((curanswer * 101.605) * 10000)
							hectogram = float((curanswer * 1.01605) * 10000)
							hundredWeight = float((curanswer * 0.002240007) * 10000)
							kilogram = float((curanswer * 0.101605) * 10000)
							megagram = float((curanswer * 0.000101605) * 10000)
							metricQuintal = float((curanswer * 0.00101605) * 10000)
							metricTon = float((curanswer * 0.000101605) * 10000)
							microgram = float((curanswer * 101605000) * 10000)
							milligram = float((curanswer * 101605) * 10000)
							ounce = float((curanswer * 3.584011) * 10000)
							picogram = float((curanswer * 101605000000000) * 10000)
							pound = float((curanswer * 0.2240007) * 10000)
							shortTon = float((curanswer * 0.0001120003) * 10000)
							slug = float((curanswer * 0.006962154) * 10000)
							stick = float((curanswer * 0.8835217) * 10000)
							stone = float((curanswer * 0.01600005) * 10000)
							tola = float((curanswer * 8.711138) * 10000)
							ton = float((curanswer * 0.0001120003) * 10000)
							TroyOunce = float((curanswer * 3.266677) * 10000)
							USQuintal = float((curanswer * 0.002240007) * 10000)
							print ("Atomic Mass Units: " + str(AtomicMassUnit))
							print ("Carats: " + str(carats))
							print ("Centigrams:  " + str(centigram))
							print ("Decgrams: " + str(decigram))
							...
							bloat1 = input("| FAIL! SETUP RESTARTING (we can't fix the bug right now, we are porting features in. Stabilizing later, my bad)")
						if measureType == ("Megagram"):
							curanswer = float(MegaGramCalc + unit2)
							print ("The answer is: " + str(curanswer) + " Megagrams")
							print ("This is also equal to: ")
							AtomicMassUnit = float((curanswer * 602214129010000003072) * 100000000)
							carats = float((curanswer * 500) * 10000) 
							centigram = float((curanswer * 10000) * 10000)
							decigram = float((curanswer * 1000) * 10000)
							dekagram = float((curanswer * 10) * 10000)
							dram = float((curanswer * 56.43834) * 10000)
							femtogram = float((curanswer * 100000000000000000) * 10000)
							frenchQuintal = float((curanswer * 0.0006713662) * 10000)
							grain = float((curanswer * 1543.236) * 10000)
							gram = float((curanswer * 100) * 10000)
							hectogram = float((curanswer * 1) * 10000)
							hundredWeight = float((curanswer * 0.0022046237) * 10000)
							kilogram = float((curanswer * 0.1) * 10000)
							longTon = float((curanswer * 0.00009842035) * 10000)
							metricQuintal = float((curanswer * 0.001) * 10000)
							metricTon = float((curanswer * 0.0001) * 10000)
							microgram = float((curanswer * 101605000) * 10000)
							milligram = float((curanswer * 100000) * 10000)
							ounce = float((curanswer * 3.527396) * 10000)
							picogram = float((curanswer * 100000000000000) * 10000)
							pound = float((curanswer * 0.0001102311) * 10000)
							shortTon = float((curanswer * 0.0001102311) * 10000)
							slug = float((curanswer * 0.006852177) * 10000)
							stick = float((curanswer * 0.8695652) * 10000)
							stone = float((curanswer * 0.0157473) * 10000)
							tola = float((curanswer * 8.573532) * 10000)
							ton = float((curanswer * 0.0001102311) * 10000)
							TroyOunce = float((curanswer * 3.215075) * 10000)
							USQuintal = float((curanswer * 0.002204623) * 10000)
							print ("Atomic Mass Units: " + str(AtomicMassUnit))
							print ("Carats: " + str(carats))
							print ("Centigrams:  " + str(centigram))
							print ("Decgrams: " + str(decigram))
